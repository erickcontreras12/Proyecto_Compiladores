...
HOLDLOCK|ROWCOUNT|CASE|ROWGUIDCOL|IDENTITY_INSERT|RULE|CHECKPOINT|IDENTITYCOL|CLOSE|IN|SECURITYAUDIT|COALESCE|COLLATE|
...
AUTHORIZATION|GET|GLOBAL|RELATIVE|RESTRICT|GOTO|REVOKE|BIT_LENGTH|GRANT|
BOTH|ROWS|CASCADE|HOUR|CASCADED|SCROLL|CASE|IMMEDIATE|SECOND|CAST|IN|SECTION|CATALOG|SESSION|CHAR_LENGTH|INDICATOR|
SESSION_USER|CHARACTER|INITIALLY|CHARACTER_LENGTH|SMALLINT|CLOSE|INSENSITIVE|SOME|COALESCE|INSERT|SPACE|
COLLATE|SQL|COLLATION|INTEGER|SQLCA|INTERSECT|SQLCODE|INTERVAL|SQLERROR|CONNECT|SQLSTATE|CONNECTION|IS|
SQLWARNING|ISOLATION|SUBSTRING|CONSTRAINTS|CONTINUE|SYSTEM_USER|CONVERT|LANGUAGE|CORRESPONDING|
LAST|TEMPORARY|LEADING|THEN|CROSS|LEVEL|TIMEZONE_HOUR|CURRENT_DATE|LOCAL|VALUE|zm
