...
FREETEXT|AUTHORIZATION|FREETEXTTABLE|REPLICATION|BACKUP|RESTORE|BEGIN|FULL|RESTRICT|FUNCTION|RETURN|
...
NOCHECK|TO|CURRENT_USER|NONCLUSTERED|CURSOR|TRAN|TRANSACTION|DBCC|NULLIF|TRIGGER|DEALLOCATE|OF|
DECLARE|OFF|TRY_CONVERT|OFFSETS|TSEQUAL|ON|UNION|DENY|OPEN|DESC|OPENDATASOURCE|UNPIVOT|DISK|OPENQUERY|DISTINCT|
OPENROWSET|UPDATETEXT|DISTRIBUTED|OPENXML|USE|DOUBLE|OPTION|OR|DUMP|ORDER|VARYING|ELSE|OUTER|END|OVER|WAITFOR|ERRLVL|
WHEN|ESCAPE|PIVOT|EXCEPT|PLAN|WHILE|EXEC|PRECISION|EXECUTE|WITHIN|GROUP|PRINT|WRITETEXT|EXIT|PROC1ABSOLUTE|
...
AND|FIRST|PRESERVE|ANY|ARE|FOR|PRIOR|AS|PRIVILEGES|ASC|FORTRAN|PROCEDURE|ASSERTION|FOUND|PUBLIC|AT|READ|
...
ELSE|OPTION|WITH|END|OR|WORK|END-EXEC|ORDER|WRITE|ESCAPE|OUTER|YEAR|EXCEPT|OUTPUT|ZONE|EXCEPTION {lexeme=yytext(); return PALABRA_RESERVADA;}
